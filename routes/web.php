...
Route::get('/create-task-view', [\App\Http\Controllers\TaskController::class, 'createView'])->name('task.create');
Route::post('/create-task', [\App\Http\Controllers\TaskController::class, 'store'])->name('task.create');
